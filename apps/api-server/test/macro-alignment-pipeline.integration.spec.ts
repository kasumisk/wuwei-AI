...
function buildFoodPool(): ScoredFood[] {
  const foods: FoodLibrary[] = [
    // ─── 高蛋白主食类（单品 20-35g 蛋白）───
    buildFood('chicken_breast', '鸡胸肉', 'protein', { cal: 165, p: 31, f: 3.6, c: 0 }, 120, ['lunch', 'dinner']),
    buildFood('egg_whole', '鸡蛋', 'protein', { cal: 155, p: 13, f: 11, c: 1.1 }, 100, ['breakfast', 'lunch', 'snack']),
    buildFood('salmon', '三文鱼', 'protein', { cal: 208, p: 20, f: 13, c: 0 }, 100, ['lunch', 'dinner']),
    buildFood('beef_lean', '瘦牛肉', 'protein', { cal: 217, p: 26, f: 12, c: 0 }, 100, ['lunch', 'dinner']),
    buildFood('shrimp', '虾', 'protein', { cal: 99, p: 24, f: 0.3, c: 0.2 }, 100, ['lunch', 'dinner']),
    buildFood('tofu_firm', '老豆腐', 'protein', { cal: 144, p: 16, f: 8, c: 3 }, 150, ['lunch', 'dinner']),
    buildFood('yogurt_greek', '希腊酸奶', 'protein', { cal: 97, p: 10, f: 5, c: 4 }, 150, ['breakfast', 'snack']),
    buildFood('milk_skim', '脱脂牛奶', 'protein', { cal: 34, p: 3.4, f: 0.1, c: 5 }, 250, ['breakfast', 'snack']),
    buildFood('pork_loin', '猪里脊', 'protein', { cal: 143, p: 22, f: 5, c: 0 }, 120, ['lunch', 'dinner']),
    buildFood('tilapia', '龙利鱼', 'protein', { cal: 96, p: 20, f: 1.7, c: 0 }, 150, ['lunch', 'dinner']),
    buildFood('tuna_can', '金枪鱼罐头', 'protein', { cal: 116, p: 26, f: 1, c: 0 }, 100, ['lunch', 'snack']),
    buildFood('egg_white', '蛋白', 'protein', { cal: 52, p: 11, f: 0.2, c: 0.7 }, 120, ['breakfast', 'snack']),
    buildFood('whey_protein', '乳清蛋白粉', 'protein', { cal: 400, p: 80, f: 5, c: 8 }, 30, ['breakfast', 'snack']),
    buildFood('cottage_cheese', '乳清干酪', 'protein', { cal: 98, p: 11, f: 4.3, c: 3.4 }, 150, ['breakfast', 'snack']),

    // ─── 主食/碳水类 ───
    buildFood('brown_rice', '糙米饭', 'grain', { cal: 112, p: 2.6, f: 0.9, c: 23, fiber: 1.8 }, 150, ['lunch', 'dinner']),
    buildFood('oats', '燕麦', 'grain', { cal: 389, p: 17, f: 7, c: 66, fiber: 10 }, 40, ['breakfast', 'snack']),
    buildFood('whole_wheat_bread', '全麦面包', 'grain', { cal: 247, p: 13, f: 3.4, c: 41, fiber: 7 }, 60, ['breakfast', 'snack']),
    buildFood('sweet_potato', '红薯', 'grain', { cal: 86, p: 1.6, f: 0.1, c: 20, fiber: 3 }, 200, ['lunch', 'dinner', 'breakfast']),
    buildFood('corn', '玉米', 'grain', { cal: 86, p: 3.3, f: 1.2, c: 19, fiber: 2.4 }, 150, ['lunch', 'dinner', 'breakfast']),
    buildFood('pasta_whole', '全麦意面', 'grain', { cal: 124, p: 5, f: 1.1, c: 25, fiber: 3.2 }, 150, ['lunch', 'dinner']),
    buildFood('quinoa', '藜麦', 'grain', { cal: 120, p: 4.4, f: 1.9, c: 21, fiber: 2.8 }, 150, ['lunch', 'dinner']),
    buildFood('potato', '土豆', 'grain', { cal: 77, p: 2, f: 0.1, c: 17, fiber: 2.2 }, 200, ['lunch', 'dinner']),
    buildFood('congee_mix', '杂粮粥', 'grain', { cal: 71, p: 2.5, f: 0.5, c: 14, fiber: 1.5 }, 250, ['breakfast']),

    // ─── 蔬菜类（低卡高纤维）───
    buildFood('broccoli', '西兰花', 'vegetable', { cal: 34, p: 2.8, f: 0.4, c: 7, fiber: 2.6 }, 150, ['lunch', 'dinner']),
    buildFood('spinach', '菠菜', 'vegetable', { cal: 23, p: 2.9, f: 0.4, c: 3.6, fiber: 2.2 }, 200, ['lunch', 'dinner']),
    buildFood('tomato', '番茄', 'vegetable', { cal: 18, p: 0.9, f: 0.2, c: 3.9, fiber: 1.2 }, 150, ['breakfast', 'lunch', 'dinner']),
    buildFood('cucumber', '黄瓜', 'vegetable', { cal: 16, p: 0.7, f: 0.1, c: 3.6, fiber: 0.5 }, 150, ['lunch', 'dinner', 'snack']),
    buildFood('carrot', '胡萝卜', 'vegetable', { cal: 41, p: 0.9, f: 0.2, c: 10, fiber: 2.8 }, 100, ['lunch', 'dinner']),
    buildFood('asparagus', '芦笋', 'vegetable', { cal: 20, p: 2.2, f: 0.1, c: 3.9, fiber: 2.1 }, 150, ['lunch', 'dinner']),
    buildFood('bell_pepper', '彩椒', 'vegetable', { cal: 31, p: 1, f: 0.3, c: 6, fiber: 2.1 }, 150, ['lunch', 'dinner']),

    // ─── 脂肪/坚果类（控制份量避免过量）───
    buildFood('avocado', '牛油果', 'fat', { cal: 160, p: 2, f: 15, c: 9, fiber: 7 }, 50, ['breakfast', 'lunch', 'snack']),
    buildFood('almond', '杏仁', 'fat', { cal: 579, p: 21, f: 50, c: 22, fiber: 12 }, 15, ['snack', 'breakfast']),
    buildFood('peanut_butter', '花生酱', 'fat', { cal: 588, p: 25, f: 50, c: 20, fiber: 6 }, 15, ['breakfast', 'snack']),
    buildFood('olive_oil', '橄榄油', 'fat', { cal: 884, p: 0, f: 100, c: 0 }, 5, ['lunch', 'dinner']),
    buildFood('walnut', '核桃', 'fat', { cal: 654, p: 15, f: 65, c: 14, fiber: 6.7 }, 15, ['snack', 'breakfast']),

    // ─── 水果类（补碳水 + 纤维 + 微量元素）───
    buildFood('blueberry', '蓝莓', 'fruit', { cal: 57, p: 0.7, f: 0.3, c: 14, fiber: 2.4 }, 100, ['breakfast', 'snack']),
    buildFood('strawberry', '草莓', 'fruit', { cal: 32, p: 0.7, f: 0.3, c: 7.7, fiber: 2 }, 150, ['breakfast', 'snack']),
    buildFood('orange', '橙子', 'fruit', { cal: 47, p: 0.9, f: 0.1, c: 12, fiber: 2.4 }, 200, ['breakfast', 'snack']),
    buildFood('banana', '香蕉', 'fruit', { cal: 89, p: 1.1, f: 0.3, c: 23, fiber: 2.6 }, 120, ['breakfast', 'snack']),
    buildFood('apple', '苹果', 'fruit', { cal: 52, p: 0.3, f: 0.2, c: 14, fiber: 2.4 }, 180, ['breakfast', 'snack']),
  ];
  ...
  it('四大宏量全部落入 yellow 或 green 区（偏差 ≤ 15%）', () => {
    ...
    console.log(
      ...
      report.dimensions.map(
        (d) =>
          `${d.dimension}:${(d.deviation * 100).toFixed(1)}%(${d.zone})`,
      ),
    );
