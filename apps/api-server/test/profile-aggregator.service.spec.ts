...
import { ProfileAggregatorService } from '../src/modules/diet/app/recommendation/profile-aggregator.service';
...
describe('ProfileAggregatorService', () => {
  ...
  describe('aggregateForRecommendation', () => {
    ...
    it('should use enrichedProfile.regionCode for regionalBoostMap, fallback to CN', async () => {
      ...
      // Case 2: regionCode falsy — fallback to 'CN'
      profileResolver.resolveWithDomainProfiles.mockResolvedValue({
        ...mockEnrichedProfile,
        regionCode: '',
      });
      ...
      // Case 3: regionCode undefined — fallback to 'CN'
      profileResolver.resolveWithDomainProfiles.mockResolvedValue({
        ...mockEnrichedProfile,
