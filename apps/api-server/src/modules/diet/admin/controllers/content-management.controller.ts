...
import { RecommendationQualityService } from '../services/recommendation-quality.service';
import {
...
export class ContentManagementController {
  ...
  async findRecommendationFeedback(
