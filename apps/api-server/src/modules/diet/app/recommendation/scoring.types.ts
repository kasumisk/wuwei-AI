...
export const SCORE_WEIGHTS: Record<GoalType, number[]> = {
  ...
  fat_loss: [
    0.14, 0.13, 0.07, 0.05, 0.05, 0.06, 0.09, 0.08, 0.06, 0.04, 0.03, 0.08,
    0.06, 0.06,
  ],
  muscle_gain: [
    0.13, 0.17, 0.09, 0.05, 0.05, 0.04, 0.07, 0.07, 0.04, 0.03, 0.03, 0.09,
    0.08, 0.06,
  ],
  health: [
  ...
  habit: [
    0.08, 0.06, 0.05, 0.05, 0.1, 0.09, 0.06, 0.06, 0.05, 0.04, 0.04, 0.11, 0.11,
    0.1,
  ],
};
