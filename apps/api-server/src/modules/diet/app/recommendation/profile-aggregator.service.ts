...
} from '../../../user/app/profile-resolver.service';
...
import {
  GoalPhaseService,
  type EffectiveGoal,
} from '../../../user/app/goal-phase.service';
import {
  GoalTrackerService,
  type GoalProgress,
} from '../../../user/app/goal-tracker.service';
import {
  ExecutionTrackerService,
  type SubstitutionPattern,
} from './execution-tracker.service';
import { LearnedRankingService } from './learned-ranking.service';
import {
  RealtimeProfileService,
  type ShortTermProfile,
} from '../../../user/app/realtime-profile.service';
import type { FoodFeedbackStats, UserPreferenceProfile } from './meal.types';
import type { KitchenProfile } from '../../../user/user.types';
import type { EnrichedProfileContext } from './recommendation.types';
