...
export const ENRICHMENT_FIELD_LABELS: Record<string, string> = {
  ...
  omega3: 'Omega-3脂肪酸',
  omega6: 'Omega-6脂肪酸',
  soluble_fiber: '可溶性膳食纤维',
  insoluble_fiber: '不可溶性膳食纤维',
  water_content_percent: '水分含量',
  ...
  flavor_profile: '风味画像',
  // V8.0: 扩展属性标签
  ingredient_list: '食材清单',
  cooking_methods: '烹饪方式(多选)',
  texture_tags: '口感标签',
  dish_type: '成品类型',
  prep_time_minutes: '备料时间',
  cook_time_minutes: '烹饪时间',
  skill_required: '烹饪技能要求',
  estimated_cost_level: '预估成本等级',
  shelf_life_days: '保质期',
  serving_temperature: '食用温度',
  dish_priority: '推荐优先级',
...
export const ENRICHMENT_FIELD_UNITS: Record<string, string> = {
  ...
  omega3: 'mg/100g',
  omega6: 'mg/100g',
  soluble_fiber: 'g/100g',
  insoluble_fiber: 'g/100g',
  ...
  // V8.0: 扩展属性单位
  prep_time_minutes: '分钟',
  cook_time_minutes: '分钟',
  estimated_cost_level: '级(1-5)',
  shelf_life_days: '天',
  dish_priority: '分(0-100)',
  acquisition_difficulty: '级(1-5)',
};
