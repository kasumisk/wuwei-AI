...
export class RecipeGenerationService {
  ...
  constructor(
    ...
    this.apiKey =
      ...
      '';
    this.routedClientId =
      this.configService.get<string>('RECIPE_LLM_ROUTED_CLIENT_ID')?.trim() ||
      this.configService.get<string>('LLM_ROUTED_CLIENT_ID')?.trim() ||
      null;
    this.routedRegion = this.toRuntimeRegion(
      this.configService.get<string>('RECIPE_LLM_ROUTED_REGION') ||
        this.configService.get<string>('LLM_ROUTED_REGION'),
    );
    this.routedModel =
      this.configService.get<string>('RECIPE_LLM_ROUTED_MODEL')?.trim() ||
      this.configService.get<string>('LLM_ROUTED_MODEL')?.trim() ||
      undefined;
    this.defaultModel =
