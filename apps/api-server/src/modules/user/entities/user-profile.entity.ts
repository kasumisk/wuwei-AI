...
export class UserProfile {
  ...
  @Column({
    ...
    name: 'allergens',
    comment:
      '过敏原：milk/eggs/fish/shellfish/tree_nuts/peanuts/wheat/soybeans/sesame/sulfites',
  })
  allergens: string[];
  ...
  @Column({
    ...
    comment:
      '健康状况：diabetes_type2/hypertension/high_cholesterol/gout/kidney_disease/fatty_liver/pcos/ibs',
  })
