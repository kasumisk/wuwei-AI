    ...
    <section className="mb-5">
      <div className="bg-surface-container-low rounded-2xl p-4">
        ...
        {isAdjusting ? (
          ...
          <>
            <p className="text-base font-semibold leading-snug">{content.foods}</p>
        ...
        <div className="mt-3 pt-3 border-t border-border/30 space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all active:scale-[0.97] disabled:opacity-50 ${liked ? 'bg-green-100 text-green-700 border border-green-300' : 'bg-muted text-muted-foreground hover:bg-muted/80'}`}
            >
              {liked ? '✅ 已选' : '👍 喜欢'}
            </button>
            <button
