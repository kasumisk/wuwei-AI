        ...
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-7 mb-8">
              We value your privacy. This Privacy Policy explains how we collect, use, and protect your information when you use{' '}
            ...
            <Section title="6. Children">
              <p>
                This app is not directed to children under 13. If we become aware of data collected from such users, we will delete it promptly.
              </p>
            </Section>

            <Section title="7. Updates">
              <p>We may update this policy periodically. Changes will be announced in the app or on our website.</p>
            </Section>
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-7 mb-8">
              欢迎使用 <strong className="text-slate-800 dark:text-slate-200">Procify Toolkit</strong>（以下简称&ldquo;本应用&rdquo;）。我们非常重视您的隐私和个人信息保护。本隐私政策说明我们如何收集、使用和保护您的信息。
            </p>
            ...
            <Section title="一、我们收集的信息">
              ...
              <p className="font-medium text-slate-700 dark:text-slate-300 pt-2">2. 图片与文件数据</p>
              <Ul
                items={[
              ...
              />
              <p className="font-medium text-slate-700 dark:text-slate-300 pt-2">3. 推送通知（如启用）</p>
              <Ul items={['设备推送标识符（Push Token）', '通知偏好设置']} />
              <p className="font-medium text-slate-700 dark:text-slate-300 pt-2">4. 未来可能收集的信息（如启用相关功能）</p>
              <Ul
                items={[
                  '账号信息（如邮箱、第三方登录信息）',
