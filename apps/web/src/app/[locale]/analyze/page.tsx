...
export default function AnalyzePage() {
  ...
  const { analyzeImage, saveRecord, analyzing, loading } = useFood();
          ...
          <div className="space-y-6">
            ...
            >
              {previewUrl ? (
                ...
                <img src={previewUrl} alt="预览" className="w-full max-h-64 object-contain rounded-xl" />
              ) : (
                <>
                  <div className="w-20 h-20 rounded-full bg-secondary flex items-center justify-center">
                    <svg viewBox="0 0 24 24" fill="currentColor" width="40" height="40" className="text-primary">
                      <path d="M3 4V1h2v3h3v2H5v3H3V6H0V4h3zm3 6V7h3V4h7l1.83 2H21c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2V10h3zm7 9c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm-3.2-5c0 1.77 1.43 3.2 3.2 3.2s3.2-1.43 3.2-3.2-1.43-3.2-3.2-3.2-3.2 1.43-3.2 3.2z" />
                    </svg>
                  </div>
                  <div className="text-center">
                    <p className="font-bold">拍照或上传外卖截图</p>
                    <p className="text-sm text-muted-foreground mt-1">支持 JPG、PNG、WebP，最大 10MB</p>
                  </div>
                </>
              )}
              <input
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-6">
            <div className="relative w-20 h-20">
              ...
              <div className="relative w-20 h-20 rounded-full bg-primary flex items-center justify-center">
                <svg viewBox="0 0 24 24" fill="currentColor" width="32" height="32" className="text-primary-foreground">
        ...
        {step === 'result' && result && (
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleSave}
                disabled={loading || editedFoods.length === 0}
