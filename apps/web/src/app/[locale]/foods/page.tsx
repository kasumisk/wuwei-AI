...
const metaByLocale: Record<string, { title: string; description: string; keywords: string[] }> = {
  zh: {
    title: '食物热量查询',
    description: '查询常见食物的热量和营养成分，包括蛋白质、脂肪、碳水化合物等详细数据，帮助您科学管理饮食。',
    keywords: ['食物热量', '热量查询', '营养成分', '卡路里查询', '食物库', '减肥食谱'],
  },
  en: {
    title: 'Food Calorie Lookup',
    description: 'Search calories and nutrition facts for common foods including protein, fat, and carbs to manage your diet scientifically.',
    keywords: ['food calories', 'calorie lookup', 'nutrition facts', 'calorie counter', 'food database'],
  },
  ja: {
    title: '食品カロリー検索',
  ...
  fr: {
    ...
    description: 'Rechercher les calories et les informations nutritionnelles des aliments courants.',
