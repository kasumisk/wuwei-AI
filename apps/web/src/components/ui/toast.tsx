...
function Toast({
  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-4 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=move]:translate-x-[--radix-toast-swipe-move-x] data-[swipe=move]:transition-none data-[variant=default]:border-border data-[variant=default]:bg-background data-[variant=default]:text-foreground data-[variant=destructive]:border-destructive data-[variant=destructive]:bg-destructive data-[variant=destructive]:text-destructive-foreground data-[variant=destructive]:group-[.toaster]:border-destructive data-[variant=destructive]:group-[.toaster]:bg-destructive data-[variant=destructive]:group-[.toaster]:text-destructive-foreground',
        className
      )}
      {...props}
    />
